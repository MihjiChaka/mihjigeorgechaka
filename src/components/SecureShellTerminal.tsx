      ...
      <div className="bg-[#121215]/80 border-t border-white/5 px-4 py-3 flex flex-wrap gap-2 items-center select-none">
        ...
        {commandButtons.map((btn) => (
          <button
            ...
            className="terminal-command-btn px-2.5 py-1 bg-white/5 hover:bg-white hover:text-[#080a0c] rounded-md text-zinc-400 border border-white/5 cursor-pointer text-[10px] tracking-wide font-sans hover:-translate-y-0.5 transition active:translate-y-0 duration-200"
          >
            {btn}
          </button>
        ))}
